                ...
                <div class="product-dtl">
                    <div class="product-info">
                        ...
                        <div class="reviews-counter">
                            <div class="rate">
                                <span> Rating: <?php if(isset($averageRating)){
                                    echo $averageRating;
                                    } ?></span>
                            </div>
                            <span><?php print_r(count($reviews)); ?> Reviews</span>
                        </div>
                        <div class="product-price-discount"><span> <?= $product->getPrice().'$'; ?></span><span class="line-through">$29.00</span></div>
                    </div>
        ...
        <div class="product-info-tabs">
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                    ...
                    <p class="mb-20">There are <?php print_r(count($reviews)); ?> reviews yet.</p>
                    <form action="/addReview" method="post">
                        ...
                        <div class="form-group">
                            ...
                            if(isset($errors['text'])) {
                                print_r ($errors['text']); } ?>
                            <textarea class="form-control"  name= "review_text" rows="10"> </textarea>
                    ...
                    <h5> Name:<?php echo $review->getUserName(); ?></h5>
                        <h5> Rating:<?php echo $review->getRating(); ?></h5>
                        <h5> Content:<?php echo $review->getText(); ?></h5>
                    <?php endforeach; ?>
                </div>
            </div>
        </div>
